...
if __name__ == '__main__':
    ...
    parser.add_argument('--flag_2d3d', '-n', default='2d', help="(required, str, default='2d') Choosing to run 2d-cnn or 3d-cnn model", type=str)
    ...
    parser.add_argument('--batch_size', '-a', default=128, help='(optional, int, default=16) The batch size for model training', type=int)
    ...
    opt = hvd.DistributedOptimizer(adam, compression=compression)
    ...
    model_name = checkpoint_dir+'{}_{}subjects_batch{}_test1.h5'.format(model_str, args.sub_num, batch_size)  #'{model_str}-lr{learning_rate}-{epoch}.h5'
